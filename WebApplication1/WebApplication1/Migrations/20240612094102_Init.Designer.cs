            ...
            modelBuilder.Entity("WebApplication1.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2024, 6, 12, 11, 41, 1, 477, DateTimeKind.Local).AddTicks(3325),
                            DueDate = new DateTime(2024, 7, 12, 11, 41, 1, 477, DateTimeKind.Local).AddTicks(3374),
                            IdDoctor = 1,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2024, 6, 12, 11, 41, 1, 477, DateTimeKind.Local).AddTicks(3379),
                            DueDate = new DateTime(2024, 7, 12, 11, 41, 1, 477, DateTimeKind.Local).AddTicks(3381),
                            IdDoctor = 2,
                            IdPatient = 2
                        });
                });
